                ...
                <div className="max-w-3xl mx-auto space-y-4 ">
                    ...
                    <div className="bg-white rounded-lg p-6 border border-[#C5BEBE]">
                        <div className="relative">
                            ...
                            <Link to="/user/profile-update">
                                <button
                                    className="absolute bottom-0 right-0 px-4 py-2 bg-[#2B7A0B] text-white rounded-md text-sm hover:bg-[#236508] transition-colors flex items-center gap-2">
                    ...
                    <div className="bg-white rounded-lg p-6 border border-[#C5BEBE]">
                        ...
                        <p className="text-[#404040]">
                            I am a passionate French teacher with a warm heart and a love for kids. She brings energy
                            and creativity to every lesson, making learning fun and engaging. Her patience and
                            dedication inspire young learners to embrace the beauty of the French language.
                        </p>
                    </div>
